...
{
	$clickheatConf = Piwik\Plugins\ClickHeat\Controller::getConf();
}
...
<span class="float-right"><a href="#" onclick="hideGroupLayout();
		return false;"><img src="<?php echo CLICKHEAT_PATH ?>images/ko.png" width="16" height="16" align="absmiddle" alt="Close" /></a></span>
...
<form action="#" method="get" onsubmit="return false;">
	<?php echo LANG_EXAMPLE_URL ?> <input type="text" name="url" id="formUrl" value="<?php echo htmlspecialchars($url); ?>" size="50" /> <a href="#" onclick="saveGroupLayout();
		return false;"><img src="<?php echo CLICKHEAT_PATH ?>images/save.png" width="16" height="16" alt="Save" /></a><br />
	...
	<table cellpadding="0" cellspacing="2" border="0">
		...
		for ($i = 0; $i < 7; $i++)
		{
			...
			echo '<a href="#" onclick="saveGroupLayout(); return false;"><img src="', CLICKHEAT_PATH, 'images/save.png" width="16" height="16" align="absmiddle" alt="Save" /></a></span></td>';
